...
#	$MarginContainer/HBoxContainer/BloodProgress.value = value
	...
	$Tween.start()
#	($Margin/Container/HealthBar,'value', $Margin/Container/HealthBar.value, value,0.2, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)